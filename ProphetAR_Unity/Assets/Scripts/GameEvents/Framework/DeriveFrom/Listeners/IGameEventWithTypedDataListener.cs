...
namespace ProphetAR
{
    ...
    /// </summary>
    /// <typeparam name="TInterfaceSelf"> The interface implementing this one (it passes its own type). Used to distinguish difference response methods with the same parameters </typeparam>
