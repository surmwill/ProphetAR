...
namespace ProphetAR
{
    ...
    public interface IGameEventWithTypedDataListener<TInterfaceSelf, in TData> : IGameEventWithDataListener where TInterfaceSelf : IGameEventWithTypedDataListener<TInterfaceSelf, TData>
    {
